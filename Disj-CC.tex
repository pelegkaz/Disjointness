...
So in total the cost of the round is $k + k\log(k) + k(\log(k) + \log(\frac{1}{\epsilon})) + k\log(n) \in O(k(\log(n) + \log(\frac{1}{\epsilon}))$ and we discovered $(n^{\frac{1}{k}}/2)$ zeros. \newline
There are at most $\frac{n}{n^{\frac{1}{k}}/2} = 2n^{1-\frac{1}{k}}$ rounds. \newline
