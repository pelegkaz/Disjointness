...
\paragraph{$k >> \log(n)$:}
This is an interesting case. Most of the elements in our input should be 1. I'm still thinking about a protocol for this case.
\paragraph{$k = \frac{1}{\alpha}n$:}
In this case the average player has at least $\frac{n}{k} = \alpha$ zeros.
\section{Extra}
