...
For a player $i$ with input $x_i$, define
\begin{equation*}
...
The only stage where the protocol may error is (3) where no player is significant and the protocol "guesses" the result is "not disjoint". \newline
